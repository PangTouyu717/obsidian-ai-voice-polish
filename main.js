...
var _FloatingRecorder = class _FloatingRecorder {
      ...
      case "idle":
        if (this.mode === "insert") {
          ...
          if (!target || !this.isValidTarget(target)) {
            new import_obsidian.Notice("\u26A0\uFE0F \u63D2\u5165\u6A21\u5F0F\u5C31\u7EEA\u5931\u8D25\uFF1A\u8BF7\u5148\u628A\u5149\u6807\u653E\u5230\u8981\u8F93\u5165\u7684\u4F4D\u7F6E\uFF0C\u518D\u70B9\u51FB\u5F55\u97F3");
            return;
          }
          new import_obsidian.Notice("\u2705 \u63D2\u5165\u6A21\u5F0F\u5DF2\u5C31\u7EEA\uFF0C\u5149\u6807\u5DF2\u5B9A\u4F4D");
        }
  ...
  async stopRecording() {
    ...
    try {
      ...
      new import_obsidian.Notice(`[E102] \u5F55\u97F3\u5931\u8D25: ${err}`);
      this.resetAll();
      return;
    }
    if (audioData.durationSeconds < 0.5) {
      new import_obsidian.Notice("\u5F55\u97F3\u592A\u77ED\uFF0C\u8BF7\u91CD\u65B0\u5F55\u5236");
      this.resetAll();
      return;
    }
  ...
  async doSTT(audioData) {
    ...
    try {
      ...
      new import_obsidian.Notice(`[E202] STT \u521D\u59CB\u5316\u5931\u8D25: ${err}`);
      this.resetAll();
      return;
    }
    try {
      ...
      if (!this.rawText) {
        new import_obsidian.Notice("\u672A\u80FD\u8BC6\u522B\u51FA\u6587\u5B57\uFF0C\u8BF7\u91CD\u8BD5");
        this.resetAll();
        return;
      }
  ...
  async insertTextAtCursor(text) {
    ...
    const target = this.savedTarget;
    if (!target) {
      new import_obsidian.Notice("\u274C \u672A\u68C0\u6D4B\u5230\u5149\u6807\u4F4D\u7F6E\uFF0C\u8BF7\u5148\u70B9\u51FB\u8981\u8F93\u5165\u6587\u5B57\u7684\u5730\u65B9");
      this.close();
      return;
    }
    if (target.tagName === "INPUT" || target.tagName === "TEXTAREA") {
    ...
    new import_obsidian.Notice("\u274C \u627E\u4E0D\u5230\u53EF\u63D2\u5165\u7684\u4F4D\u7F6E\uFF0C\u8BF7\u628A\u5149\u6807\u653E\u5728\u8F93\u5165\u6846\u4E2D\u518D\u8BD5");
    this.close();
  }
  ...
  async createNoteWithAudio(text) {
    ...
    try {
      ...
      for (let i = 0; i < todayNotes.length; i++) {
        ...
        if (existing instanceof import_obsidian.TFile && existing.path !== todayNotes[i].path) {
        ...
        if (oldAudio) {
          ...
          if (existingAudio instanceof import_obsidian.TFile && existingAudio.path !== oldAudio.path) {
      ...
      if (oldNote instanceof import_obsidian.TFile) {
...
`;
      ...
      new import_obsidian.Notice(`\u2705 \u5DF2\u521B\u5EFA\u8BED\u97F3\u7B14\u8BB0`);
    } catch (err) {
      new import_obsidian.Notice(`\u274C \u521B\u5EFA\u7B14\u8BB0\u5931\u8D25: ${err}`);
    }
    this.close();
  }
  ...
  checkConfig() {
    ...
    if (!s) {
      new import_obsidian.Notice("[E091] \u63D2\u4EF6\u8BBE\u7F6E\u672A\u52A0\u8F7D");
      this.close();
      return false;
    }
    if (!isSTTConfigReady(s)) {
      new import_obsidian.Notice(getSTTConfigHint(s));
      this.close();
      return false;
    }
    if (!s.deepseekApiKey) {
      new import_obsidian.Notice("\u8BF7\u5148\u5728\u8BBE\u7F6E\u4E2D\u586B\u5199 DeepSeek API Key");
      this.close();
      return false;
    }
    return true;
...
var AiVoicePolishSettingTab = class extends import_obsidian2.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian2.Setting(containerEl).setName("STT \u670D\u52A1\u5546").setDesc("\u9009\u62E9\u8BED\u97F3\u8F6C\u6587\u5B57\u7684\u670D\u52A1\u63D0\u4F9B\u5546").addDropdown((dropdown) => {
      const providers = [
        "volcengine",
        "qwen",
        "openai-whisper"
    ...
    if (this.plugin.settings.sttProvider === "volcengine") {
      ...
      new import_obsidian2.Setting(containerEl).setName("Access Key").setDesc("\u706B\u5C71\u5F15\u64CE\u7684 Access Key").addText(
      ...
      new import_obsidian2.Setting(containerEl).setName("Secret Key").setDesc("\u706B\u5C71\u5F15\u64CE\u7684 Secret Key").addText((text) => {
      ...
      new import_obsidian2.Setting(containerEl).setName("App ID").setDesc("\u706B\u5C71\u5F15\u64CE\u8BED\u97F3\u8BC6\u522B\u5E94\u7528\u7684 App ID").addText(
    ...
    if (this.plugin.settings.sttProvider === "qwen") {
      ...
      new import_obsidian2.Setting(containerEl).setName("API Key").setDesc("\u5343\u95EE\uFF08DashScope\uFF09\u7684 API Key\uFF0C\u4EE5 sk- \u5F00\u5934").addText((text) => {
    ...
    if (this.plugin.settings.sttProvider === "openai-whisper") {
      ...
      new import_obsidian2.Setting(containerEl).setName("API Key").setDesc("OpenAI API Key\uFF08\u9884\u7559\u5B57\u6BB5\uFF09").addText((text) => {
    ...
    new import_obsidian2.Setting(containerEl).setName("\u7B14\u8BB0\u5B58\u653E\u6587\u4EF6\u5939").setDesc("\u8BED\u97F3\u7B14\u8BB0 .md \u6587\u4EF6\u7684\u5B58\u653E\u8DEF\u5F84").addText(
    ...
    new import_obsidian2.Setting(containerEl).setName("\u97F3\u9891\u5B58\u653E\u6587\u4EF6\u5939").setDesc("\u5F55\u97F3\u97F3\u9891 .webm \u6587\u4EF6\u7684\u5B58\u653E\u8DEF\u5F84").addText(
    ...
    new import_obsidian2.Setting(containerEl).setName("API Key").setDesc("DeepSeek \u7684 API Key").addText((text) => {
    ...
    new import_obsidian2.Setting(containerEl).setName("\u6DA6\u8272\u98CE\u683C").setDesc("\u9009\u62E9 AI \u6DA6\u8272\u7684\u9ED8\u8BA4\u98CE\u683C").addDropdown(
    ...
    new import_obsidian2.Setting(containerEl).setName("\u81EA\u5B9A\u4E49\u6DA6\u8272\u6307\u4EE4").setDesc(
    ...
    new import_obsidian2.Setting(containerEl).setName("\u81EA\u52A8\u63D2\u5165").setDesc(
  ...
  addTestButton(label, testFn) {
    const setting = new import_obsidian2.Setting(this.containerEl).setDesc("").addButton((btn) => {
      ...
      btn.onClick(async () => {
        ...
        try {
          ...
          if (result.ok) {
            new import_obsidian2.Notice(result.message, 3e3);
...
var AiVoicePolishPlugin = class extends import_obsidian3.Plugin {
  constructor() {
    super(...arguments);
  ...
  async onload() {
    ...
    (0, import_obsidian3.addIcon)("avp-mic", MIC_ICON);
  ...
  async polishSelectedText() {
    ...
    if (!view) {
      new import_obsidian3.Notice("\u6CA1\u6709\u6253\u5F00\u7684\u7F16\u8F91\u5668");
      return;
    }
    const editor = view.editor;
    const selectedText = editor.getSelection();
    if (!selectedText) {
      new import_obsidian3.Notice("\u8BF7\u5148\u9009\u4E2D\u8981\u6DA6\u8272\u7684\u6587\u672C");
      return;
    }
    new import_obsidian3.Notice("\u6DA6\u8272\u529F\u80FD\u5C06\u5728\u540E\u7EED\u7248\u672C\u5B9E\u73B0");
  }
  async loadSettings() {
